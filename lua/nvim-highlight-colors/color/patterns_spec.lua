...
describe("Patterns", function()
	...
	it("should return false if color is not rgb", function()
		...
		assert.is_false(patterns.is_rgb_color("rgb(33ccff)"))
		assert.is_false(patterns.is_rgb_color("rgba(33ccffee)"))
	end)

	it("should return true if color is hyprland rgb/rgba", function()
		assert.is_true(patterns.is_hyprland_color("rgb(33ccff)"))
		assert.is_true(patterns.is_hyprland_color("rgba(33ccffee)"))
		assert.is_true(patterns.is_hyprland_color("rgb(112233)"))
	end)

	it("should return false if color is not hyprland rgb/rgba", function()
		assert.is_false(patterns.is_hyprland_color("rgb(255, 255, 255)"))
		assert.is_false(patterns.is_hyprland_color("rgba(92, 92, 255 / 0.2)"))
		assert.is_false(patterns.is_hyprland_color("rgb(33ccf)"))
		assert.is_false(patterns.is_hyprland_color("rgb(33ccfff)"))
		assert.is_false(patterns.is_hyprland_color("#33ccff"))
		assert.is_false(patterns.is_hyprland_color("hsl(240, 100%, 50%)"))
	end)
	...
	it("should return true if color is oklch", function()
		assert.is_true(patterns.is_oklch_color("oklch(0.7 0.15 200)"))
		assert.is_true(patterns.is_oklch_color("oklch(70% 0.15 200deg)"))
		assert.is_true(patterns.is_oklch_color("oklch(0.5 0.2 120rad)"))
		assert.is_true(patterns.is_oklch_color("oklch(0.5 0.2 0.5turn)"))
		assert.is_true(patterns.is_oklch_color("oklch(1 0 0)"))
		assert.is_true(patterns.is_oklch_color("oklch(0.7 0.15 200 / 0.5)"))
	end)
	...
	it("should return true if color is ansi color", function()
		...
		assert.is_true(patterns.is_ansi_color("\\033[31m"))
		assert.is_true(patterns.is_ansi_color("\\033[90m"))
		assert.is_true(patterns.is_ansi_color("\\033[1;4;32m"))
	end)
