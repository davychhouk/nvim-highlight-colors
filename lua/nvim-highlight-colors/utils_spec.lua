...
describe("Utils", function()
	...
	it("should create highlight for hex color in foreground mode", function()
		...
		assert.spy(vim.api.nvim_buf_set_extmark).was.called_with(
			...
			{ end_col = params.data.end_column, hl_group = "nvim-highlight-colors-foregroundFFFFFFFFFFFF" }
		)
	end)
	...
	it("should create highlight for hex color in background mode", function()
		...
		assert.spy(vim.api.nvim_buf_set_extmark).was.called_with(
			...
			params.data.row + 1,
			params.data.start_column,
			{ end_col = params.data.end_column, hl_group = "nvim-highlight-colors-backgroundFFFFFFFFFFFF" }
		)
	end)
	...
	it("should create highlight for short hex color in background mode", function()
		...
		assert.spy(vim.api.nvim_buf_set_extmark).was.called_with(
			...
			params.data.row + 1,
			params.data.start_column,
			{ end_col = params.data.end_column, hl_group = "nvim-highlight-colors-backgroundFFFFFFFFF" }
		)
	end)
	...
	it("should create highlight for custom colors in background mode", function()
		...
		assert.spy(vim.api.nvim_buf_set_extmark).was.called_with(
			...
			params.data.row + 1,
			params.data.start_column,
			{ end_col = params.data.end_column, hl_group = "nvim-highlight-colors-backgroundcustomcolorFFFFFF" }
		)
	end)
